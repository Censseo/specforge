...
3. **From specforge legacy**: `specs/{feature}/` → consolidate into domains
...
8. **Generate `/docs/{domain}/spec.md`** for each domain:
   ...
   > Generated by /specforge.setup-docs on {date}
...
9. **Generate `/docs/README.md`**:
   ...
   > Initialized by /specforge.setup-docs on {date}
...
3. Run /specforge.learn to extract patterns
4. Use /specforge.specify for new features
```
